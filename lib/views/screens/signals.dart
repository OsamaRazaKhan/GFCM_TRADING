  ...
  Widget build(BuildContext context) {
    return GetBuilder<SignalsController>(
      builder: (controller) {
        ...
        final activeSignals = controller.signalsList.where((s) => controller.isSignalActive(s)).toList();
        // Filter responded/expired signals
        final inactiveSignals = controller.signalsList.where((s) => !controller.isSignalActive(s)).toList();
                ...
                : allSignals.isEmpty
                    ? Padding(
                        ...
                        child: CustomEmptyScreenMessage(
                          ...
                          subtext: "Refresh the page or stay connected to get the latest trading signals.",
                          onTap: () {
                            controller.getSignals();
                          },
                        ),
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isExpanded = controller.expandedSignals[signal.id] ?? false;
                          final remainingSeconds = controller.getRemainingSeconds(signal);
                          final isExpired = remainingSeconds <= 0;
                          final isLoading = controller.isSignalsUpdateLoading[signal.id] ?? false;
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          if (isActive && !isExpired)
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                controller.toggleSignalExpansion(signal.id ?? 0);
                                              },
                                            ),
                                        ],
                                      ),
                                      ...
                                      // Signal message
                                      CustomText(
                                        signal.message?.trim() ?? "No message",
                                        size: 14.sp,
                                        color: isActive && !isExpired
                                            ? colorConstants.blackColor
                                            : colorConstants.hintTextColor,
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: status == 'accepted'
                                                    ? colorConstants.greenColor.withOpacity(0.2)
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: ElevatedButton(
                                              onPressed: (isLoading || controller.pressedButton[signal.id] != null)
                                                  ? null
                                                  : () async {
                                                      await controller.updateSignalStatus(
                                                        signal.id ?? 0,
                                                        "Accepted",
                                                      );
                                                    },
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor: controller.pressedButton[signal.id] == "Accepted"
                                                ...
                                                elevation: controller.pressedButton[signal.id] == "Accepted" ? 2 : 0,
                                              ),
                                              child: (isLoading && controller.pressedButton[signal.id] == "Accepted") || 
                                                     (controller.isSignalsUpdateLoading[signal.id] == true && controller.pressedButton[signal.id] == "Accepted")
                                                  ? SizedBox(
                                                      height: 20.h,
                                                      width: 20.w,
                                                      child: CircularProgressIndicator(
                                          ...
                                          Expanded(
                                            child: ElevatedButton(
                                              ...
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor: controller.pressedButton[signal.id] == "Rejected"
                                                    ? colorConstants.redColor.withOpacity(0.7)
                                                    : colorConstants.redColor,
                                                padding: EdgeInsets.symmetric(vertical: 12.h),
                                                shape: RoundedRectangleBorder(
                                                  borderRadius: BorderRadius.circular(8.r),
                                                ),
                                                elevation: controller.pressedButton[signal.id] == "Rejected" ? 2 : 0,
                                              ),
                                              child: (isLoading && controller.pressedButton[signal.id] == "Rejected") || 
                                                     (controller.isSignalsUpdateLoading[signal.id] == true && controller.pressedButton[signal.id] == "Rejected")
                                                  ? SizedBox(
                                                      height: 20.h,
                                                      width: 20.w,
                                                      child: CircularProgressIndicator(
