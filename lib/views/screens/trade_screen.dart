...
class _TradeScreenState extends State<TradeScreen> with RouteAware {
        ...
        return !tradeChartController.isConnectedToInterNet.value &&
            ...
            : Column(
              children: [
                  ...
                  child: Obx(() {
                    return Column(
                      children: [
                        ...
                        Visibility(
                          visible:
                              tradeChartController.credit.value > 0.0 &&
                              tradeChartController.selectedMode.value == "Real",
                          child: Padding(
                            padding: EdgeInsets.symmetric(
                              horizontal: 12.0,
                        ...
                        Visibility(
                          visible:
                              tradeChartController.positions.isNotEmpty &&
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CustomText(
                                  fmt(tradeChartController.marginUsed.value),
                                  size: 14.sp,
                                  fw: FontWeight.w400,
                                  color:
                                      Theme.of(context).brightness ==
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              CustomText(
                                fmt(tradeChartController.freeMargin.value),
                                size: 14.sp,
                                fw: FontWeight.w400,
                                color:
                                    Theme.of(context).brightness ==
                ...
                Visibility(
                  visible: tradeChartController.positions.isNotEmpty || tradeChartController.pendingOrders.isNotEmpty,
                  child: ListTile(
                    onTap: () {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Obx(() {
                                      ...
                                      bool hasActivePositions = c.positions.isNotEmpty;

                                      bool hasProfitable = c.positions.any((p) {
                                        final exitPrice =
                                      ...
                                      bool hasLosing = c.positions.any((p) {
                                        final exitPrice =
                                            (p.side == TradeSide.buy)
                                                ? c.bidPrice.value
                                                : c.askPrice.value;
                        ...
                        : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              final isPendingOrder = item is PendingOrder;
  ...
  Widget _buildActiveTradeTile(Position p, TradeChartController c) {
    final exitPrice = (p.side == TradeSide.buy) ? c.bidPrice.value : c.askPrice.value;
    final pl = CalculatePl.calculatePL(p, exitPrice, tradeChartController.kGoldContractSizePerLot);
    ...
    return ListTile(
        ...
        if (tradeChartController.isConnectedToInterNet.value) {
          if (tradeChartController.marketOpen.value) {
            if (!tradeChartController.isLiquidating) {
              final double sl = p.stopLoss == null || p.stopLoss == 0.0 ? 0.0 : p.stopLoss ?? 0.0;
              final double tp = p.takeProfit == null || p.takeProfit == 0.0 ? 0.0 : p.takeProfit ?? 0.0;
              c.updateSLTPValue(sl, tp);
              Get.to(() => ModifyPositionScreen(sL: sl, tP: tp, trade: p, profitLoss: pl));
            }
          } else {
            FlushMessages.commonToast(
              "The market is currently closed. You cannot close or modify trades until it reopens",
      ...
      title: Row(
        children: [
          CustomText('XAUUSD, ', size: 16.sp, fw: FontWeight.w600, color: colorConstants.blackColor),
          CustomText(
            '${p.side == TradeSide.buy ? 'Buy' : 'Sell'} ${p.lots.toStringAsFixed(2)}',
            size: 12.sp,
            fw: FontWeight.w700,
            color: p.side == TradeSide.sell ? colorConstants.redColor : colorConstants.blueColor,
          ),
          SizedBox(width: 8.w),
          Container(
            padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 4.h),
      ...
      subtitle: Column(
        ...
        children: [
          Row(
            children: [
              CustomText(p.entryPrice.toStringAsFixed(2), size: 14.sp, color: colorConstants.hintTextColor),
              SizedBox(width: 5.w),
              Icon(Icons.arrow_forward, size: 12.sp, color: colorConstants.iconGrayColor),
              SizedBox(width: 5.w),
              CustomText(exitPrice.toStringAsFixed(2), size: 12.sp, color: colorConstants.hintTextColor),
            ],
          ),
            ...
            Row(
              children: [
                if (p.stopLoss != null && p.stopLoss != 0.0)
                  CustomText("SL: ${p.stopLoss!.toStringAsFixed(2)}", size: 12.sp, color: colorConstants.redColor),
                SizedBox(width: p.stopLoss == null || p.stopLoss == 0.0 ? 0.w : 8.w),
                if (p.takeProfit != null && p.takeProfit != -0.0)
                  CustomText("TP: ${p.takeProfit!.toStringAsFixed(2)}", size: 12.sp, color: colorConstants.blueColor),
              ],
            ),
          ],
        ],
    ...
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          Row(
            children: [
              CustomText(entryPrice.toStringAsFixed(2), size: 14.sp, color: colorConstants.hintTextColor),
              SizedBox(width: 5.w),
              Icon(Icons.arrow_forward, size: 12.sp, color: colorConstants.iconGrayColor),
              SizedBox(width: 5.w),
              CustomText(exitPrice.toStringAsFixed(2), size: 12.sp, color: colorConstants.hintTextColor),
          ...
          if (apiTrade.stopLoss != null || apiTrade.takeProfit != null) ...[
            ...
            Row(
              children: [
                ...
                SizedBox(width: apiTrade.stopLoss == null || apiTrade.stopLoss == 0.0 ? 0.w : 8.w),
