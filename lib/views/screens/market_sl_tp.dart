...
class SLTPOrderScreen extends StatefulWidget {
  const SLTPOrderScreen({super.key});

  @override
  State<SLTPOrderScreen> createState() => _SLTPOrderScreenState();
}

class _SLTPOrderScreenState extends State<SLTPOrderScreen> {
  ...
  Future<void> applyOrder() async {
    ...
    try {
      ...
      await controller.openTradeWithSLTP(
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8.h),
                        CustomText(
                          ep > 0 ? ep.toStringAsFixed(2) : "Waiting...",
                          size: 24.sp,
                          fw: FontWeight.w700,
                          color: colorConstants.secondaryColor,
                        ),
